                    ...
                    >
                        <div class="">
                            <figure class="mx-auto max-w-screen-md text-center">
                                <svg
                                    aria-hidden="true"
                                    class="mx-auto mb-3 w-12 h-12 text-white"
                                    viewBox="0 0 24 27"
                                    fill="none"
                                ...
                                <blockquote>
                                    <p
                                        class="text-2xl italic font-medium text-white"
                                    >
                                ...
                                >
                                    ...
                                    >
                                        <cite
                                            class="pr-3 font-medium text-white"
                                            >Mandate</cite
                                        >
                                    </div>
                                </figcaption>
