...
<template>
    ...
    <div class="relative bg-pattern flex items-top justify-center min-h-screen sm:items-center sm:pt-0">
        ...
        <div class="w-full bg-white">
            ...
            <section>
                <div class="overflow-hidden bg-cmu backdrop-opacity-50 backdrop-blur-lg text-white py-20" style="
                    ...
                    <scroll-parallax :right="true" direction="x">
                        <div
                            ...
                            <div class="flex flex-col justify-center items-start p-8">
                                <h1 class="text-3xl md:text-5xl p-2 text-green-800 w-full">
                                    Central Mindanao University
                                </h1>
            ...
            <div class="font-mono bg-green-900 mb-4">
                <h2 class="mb-2 text-[3rem] font-extrabold text-start ml-4 text-yellow-600 flex">
                    Colleges
            ...
            <section class="bg-gray-50 px-5">
                <div class="py-8 px-4 mx-auto sm:py-16 lg:px-6">
                    <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-6 md:gap-12 md:space-y-0">
                        <div class="p-2 drop-shadow-sm" v-for="(colleges, key) in usePage().props.value
                        .colleges" :key="key">
            ...
            <div class="font-mono bg-green-900">
                <h2 class="text-[3rem] font-extrabold text-start ml-4 text-yellow-600 flex">
                    Announcements
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" class="w-12 mt-2 ml-2 h-12">
                        <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <section class="px-10 bg-gray-200">
                <div class="py-8 px-4 mx-auto sm:py-16 lg:px-6">
                    <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-2 md:gap-12 md:space-y-0">
                        ...
                        .announcements" :key="key" class="px-8 py-4 bg-white rounded-lg shadow-md dark:bg-gray-800">
                ...
                <div class="py-8 px-4 mx-auto">
                    <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
                        ...
                        .events" :key="key" class="flex">
                            <p id="vertical_date"
                                class="rounded-lg lg:bg-transparent text-green-900 pt-1 text-center">
                                {{
                            ...
                            <p id="vertical_date"
                                class=" rounded-lg lg:bg-transparent text-yellow-600 pt-1 text-center">
                                {{
            ...
            <footer class="p-4 bg-gray-50 sm:p-6">
                <div class="mx-auto">
                    ...
                    <div class="sm:flex sm:items-center sm:justify-between text-center">
                        <span class="text-sm text-gray-500 sm:text-center">© 2022
                            <a href="#" class="hover:underline">Central Mindanao University</a>. All Rights Reserved.
                        </span>
                    </div>
                </div>
            </footer>
