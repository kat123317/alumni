                    ...
                    <div class="space-y-8  md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
                        <div class="">
                            ...
                            <figure class="mx-auto max-w-screen-md text-center">
                                <svg aria-hidden="true" class="mx-auto mb-3 w-12 h-12 text-gray-400"
                                ...
                                <blockquote>
                                    <p class="text-2xl italic font-medium text-gray-900">Section 2 of
                                ...
                                <figcaption class="flex justify-center items-center mt-6 space-x-3">
                                    ...
                                    <div class="flex items-center divide-x-2 divide-gray-500">
                                        <cite class="pr-3 font-medium text-gray-900">Mandate</cite>
                        ...
                        <div class="">
                            <figure class="mx-auto max-w-screen-md text-center">
                                ...
                                <blockquote>
                                    <p class="text-2xl italic font-medium text-gray-900">To advance the
                                        frontier of
                                ...
                                <figcaption class="flex justify-center items-center mt-6 space-x-3">
                                    ...
                                    <div class="flex items-center divide-x-2 divide-gray-500 ">
                                        <cite class="pr-3 font-medium text-gray-900">Mission</cite>
                        ...
                        <div>
                            <figure class="mx-auto max-w-screen-md text-center">
                                ...
                                <blockquote>
                                    <p class="text-2xl italic font-medium text-gray-900">A leading ASEAN
                                        university actively
                                ...
                                <figcaption class="flex justify-center items-center mt-6 space-x-3">
                                    ...
                                    <div class="flex items-center divide-x-2 divide-gray-500 ">
                                        <cite class="pr-3 font-medium text-gray-900 ">Vision</cite>
