...
//   return usePage().props.value.search.id ? usePage().props.value.search.id:'no_select'
// })
...
const filter_table_show = () => {
    select_course_view.get(route("administrator.course"));
};
        ...
        <section class="text-gray-600 body-font relative">
            <div v-if="alertOn" class="bg-green-100 alertanim text-center py-4 lg:px-4">
                <div class="p-2 bg-green-800 items-center text-green-100 leading-none lg:rounded-full flex lg:inline-flex"
                    ...
                    <span class="font-semibold mr-2 text-left flex-auto">Program Successfully added</span>
            ...
            <div v-if="alertOnUpdate" class="bg-blue-100 alertanim text-center py-4 lg:px-4">
                <div class="p-2 bg-blue-800 items-center text-blue-100 leading-none lg:rounded-full flex lg:inline-flex"
                    ...
                    <span class="font-semibold mr-2 text-left flex-auto">Program Successfully updated</span>
                    <svg class="fill-current opacity-75 h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                        <path
                            d="M12.95 10.707l.707-.707L8 4.343 6.586 5.757 10.828 10l-4.242 4.243L8 15.657l4.95-4.95z" />
                    </svg>
            ...
            <div v-if="alertOnDelete" class="bg-red-100 alertanim text-center py-4 lg:px-4">
                <div class="p-2 bg-red-800 items-center text-red-100 leading-none lg:rounded-full flex lg:inline-flex"
                    ...
                    <span class="font-semibold mr-2 text-left flex-auto">Program Successfully deleted</span>
                    <svg class="fill-current opacity-75 h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                        <path
                            d="M12.95 10.707l.707-.707L8 4.343 6.586 5.757 10.828 10l-4.242 4.243L8 15.657l4.95-4.95z" />
                    </svg>
            ...
            <div class="container rounded-lg shadow border p-10 mt-10 mx-auto">
                ...
                <div class="">
                    <div class="flex  mx-auto flex-wrap -m-2">
                        <div class="p-2 w-1/3 ">
                            <div class="relative">
                        ...
                        <div class="p-2  w-1/2">
                            <div class="relative">
                                <label for="email" class="leading-7 text-sm text-gray-600">Program</label>
                        ...
                        <div class="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
                            <div class="overflow-x-auto relative shadow-md sm:rounded-lg">
                                    ...
                                    <div class="relative">
                                        <select v-model="select_course_view.search" @change="filter_table_show()"
                                            ...
                                            <option v-for="(
                                                ...
                                                .colleges" :key="key" :value="colleges.id">
                                                {{ colleges.name }}
                                            </option>
                                        </select>
                                    </div>
                                ...
                                <div class="px-4 w-100 py-3 flex items-center justify-center border-gray-200 sm:px-6">
                                    <Pagination v-bind:links="$page.props.courses.links"
                                        :search="select_course_view.search" />
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div
                            ...
                            <div class="relative bg-white rounded-lg shadow">
                                ...
                                <div class="p-6 text-center">
                                    ...
                                    <button @click="function_delete_event()" data-modal-toggle="popup-modal"
                                        type="button"
                            ...
                            <div class="relative bg-white rounded-lg shadow">
                                ...
                                <div class="p-2 w-full">
                                    <div class="relative">
                                        ...
                                        <input v-model="
                                            update_course_data.image_name
                                        " type="email" id="email" name="email"
                                            class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-green-500 focus:bg-white focus:ring-2 focus:ring-green-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
                                            disabled />
                                        <input id="course-hidden-edit" type="file" class="hidden"
                                            accept="image/png, image/gif, image/jpeg" />
                                ...
                                <div class="p-6 text-center">
                                    ...
                                    <button @click="function_update_course()" data-modal-toggle="popup-modal"
                                        type="button"
                                        class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2">
                                        Yes, I'm sure
                                    </button>
