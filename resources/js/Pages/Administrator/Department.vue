...
const function_update_college = () => {
    update_college_data.post(
        route("colleges.update", { id: update_college_data.id }),
        {
            preserveScroll: true,
            onSuccess: () => {
...
const function_delete_college = () => {
    delete_college_data.delete(
        route("colleges.delete", [delete_college_data.id]),
        {
            preserveScroll: true,
            onSuccess: () => {
                college_data.reset();
        ...
        <section class="text-gray-600 body-font relative">
            ...
            >
                ...
                >
                    ...
                    <span class="font-semibold mr-2 text-left flex-auto"
                        >College Successfully added</span
                    >
                    <svg
            ...
            >
                ...
                >
                    ...
                    >
                    <span class="font-semibold mr-2 text-left flex-auto"
                        >College Successfully updated</span
                    >
                    <svg
                        class="fill-current opacity-75 h-4 w-4"
                        xmlns="http://www.w3.org/2000/svg"
            ...
            >
                ...
                >
                    ...
                    >
                    <span class="font-semibold mr-2 text-left flex-auto"
                        >College Successfully deleted</span
                    >
                    <svg
                        class="fill-current opacity-75 h-4 w-4"
                        xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="container  shadow border rounded-lg p-10 mt-10 mx-auto">
                    ...
                    <div class="flex flex-wrap -m-2">
                        <div class="p-2 w-1/3">
                            <div class="relative">
                                ...
                                >
                                <input
                                    v-model="college_data.abbreviation"
                                    type="text"
                                    id="name"
                                    name="name"
                            ...
                            <div class="relative bg-white rounded-lg shadow">
                                <div class="p-2 w-full">
                                    <div class="relative">
                                        ...
                                        <input
                                            v-model="
                                                update_college_data.abbreviation
                                            "
                                            type="text"
                                            id="name"
                                            name="name"
                                ...
                                <div class="p-2 w-full">
                                    <div class="relative">
                                        ...
                                        >
                                        <input
                                            v-model="update_college_data.name"
                                            type="text"
                                            id="name"
                                            name="name"
                                            class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-green-500 focus:bg-white focus:ring-2 focus:ring-green-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
