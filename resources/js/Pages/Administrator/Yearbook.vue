        ...
        <section class="text-gray-600 body-font  relative">
            <div v-if="alertOn" class="bg-green-100 alertanim text-center py-4 lg:px-4">
                <div class="p-2 bg-green-800 items-center text-green-100 leading-none lg:rounded-full flex lg:inline-flex"
                    ...
                    <span class="font-semibold mr-2 text-left flex-auto">Yearbook Successfully added</span>
            ...
            <div v-if="alertOnUpdate" class="bg-blue-100 alertanim text-center py-4 lg:px-4">
                <div class="p-2 bg-blue-800 items-center text-blue-100 leading-none lg:rounded-full flex lg:inline-flex"
                    ...
                    <span class="font-semibold mr-2 text-left flex-auto">Yearbook Successfully updated</span>
                    <svg class="fill-current opacity-75 h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                        <path
                            d="M12.95 10.707l.707-.707L8 4.343 6.586 5.757 10.828 10l-4.242 4.243L8 15.657l4.95-4.95z" />
                    </svg>
            ...
            <div v-if="alertOnDelete" class="bg-red-100 alertanim text-center py-4 lg:px-4">
                <div class="p-2 bg-red-800 items-center text-red-100 leading-none lg:rounded-full flex lg:inline-flex"
                    ...
                    <span class="font-semibold mr-2 text-left flex-auto">Yearbook Successfully deleted</span>
                    <svg class="fill-current opacity-75 h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                        <path
                            d="M12.95 10.707l.707-.707L8 4.343 6.586 5.757 10.828 10l-4.242 4.243L8 15.657l4.95-4.95z" />
                    </svg>
                ...
                <div class="flex flex-col p-10  text-center w-full mb-12">
                    ...
                    <div class="p-2 w-full">
                        <div class="relative">
                            ...
                            <input v-model="yearbook_data.schoolyear_from" type="month" id="name" name="name"
                    ...
                    <div class="p-2 w-full">
                        <div class="relative">
                            ...
                            <input v-model="yearbook_data.schoolyear_to" type="month" id="name" name="name"
                                class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-green-500 focus:bg-white focus:ring-2 focus:ring-green-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
                        </div>
                    </div>
                ...
                <div class="lg:w-full md:w-2/3 mx-auto">
                    ...
                    <div class="overflow-x-auto relative shadow-md sm:rounded-lg">
                            ...
                            <tbody>
                                ...
                                .value.yearbooks.data" :key="index" class=" border-b">
                                    ...
                                    <td class="py-4 px-6 text-center">
                                        <div class="pl-3">
                                            <div class="text-base flex justify-center font-semibold">
                        ...
                        <div class="px-4 w-100 py-3 flex items-center justify-center border-gray-200 sm:px-6">
                            <Pagination v-bind:links="$page.props.yearbooks.links" :search="search_data.search" />
                        </div>
                    </div>
                </div>
                    ...
                    <div id="popup-modal" tabindex="-1"
                        ...
                        <div class="relative p-4 w-full animate mt-10 max-w-md h-full md:h-auto">
                            <div class="relative bg-white rounded-lg shadow">
                                ...
                                <button @click="function_open_update()" type="button"
                                ...
                                <div class="p-6 text-center">
                                    ...
                                    <button @click="function_update_yeabook()" data-modal-toggle="popup-modal"
                                        type="button"
                                        class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2">
                                        Yes, I'm sure
                                    </button>
                                    <button @click="function_open_update()" data-modal-toggle="popup-modal"
                                        type="button"
                        ...
                        <div
                            ...
                            <div class="relative bg-white rounded-lg shadow">
                                ...
                                <div class="p-6 text-center">
                                    ...
                                    <button @click="function_delete_yeabook()" data-modal-toggle="popup-modal"
                                        type="button"
                                        class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2">
                                        Yes, I'm sure
                                    </button>
