...
const event_search = useForm({
    event_search_key: usePage().props.value.event_search_key
        ? usePage().props.value.event_search_key
        : "",
});
                        ...
                        >
                            ...
                            >
                                ...
                                <div class="relative">
                                    ...
                                    <input
                                        v-model="event_search.event_search_key"
                                        type="search"
                                        id="default-search"
                            ...
                            >
                                ...
                                <tbody>
                                    <tr
                                        v-for="(events, key) in usePage().props
                                            .value.events.data"
                                        :key="key"
                                    >
                                        <th
