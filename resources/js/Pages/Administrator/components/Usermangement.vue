            ...
            <div class="lg:w-full md:w-2/3 mx-auto">
                <nav class="mb-10  flex justify-end" aria-label="Page navigation example">
                    ...
                    <div class="relative">
                        ...
                        <input v-model="search_data.user_search_key" type="search" id="default-search"
                            ...
                            placeholder="Search">
                        <button @click="function_search_user()" type="submit"
                ...
                <div class="overflow-x-auto relative shadow-md sm:rounded-lg">
                    <table class="w-full text-sm text-left text-gray-500 ">
                        ...
                        <tbody>
                            <tr v-for="(users, index) in usePage().props.value.users.data" :key="index"
                                class="bg-white border-b ">
                                <th scope="row" class="py-4 px-6 font-medium text-gray-900">
                                    <div class="pl-3">
                                        <img class="w-10 h-10 rounded-full" :src=users.profile_photo_url
                                            alt="Jese image">
