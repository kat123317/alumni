...
const search_data = useForm({
    year_search_key:usePage().props.value.year_search_key? usePage().props.value.year_search_key:''
})
...
const add_yearbook= () => {
    if(yearbook_data.schoolyear_from == '' || yearbook_data.schoolyear_to == ''){
        ...
        <div class="lg:w-full md:w-2/3 mx-auto">
            <nav class="mb-10  flex justify-end" aria-label="Page navigation example">
                    ...
                    <div class="relative">
                        ...
                        <input v-model="search_data.year_search_key" type="search" id="default-search" class="block p-4 pl-10 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search Mockups, Logos..." required>
                        <button @click="function_search_year()" type="submit" class="text-white absolute right-2.5 bottom-2.5 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Search</button>
                    </div>
            </nav>
                    ...
                    <table class="w-full text-sm text-left text-gray-500 ">
                        ...
                        <tbody>
                            <tr v-for="(yearbooks, index) in usePage().props.value.yearbooks.data" :key="index" class="bg-white border-b ">
                                ...
                                <td class="py-4 px-6">
                                    <div class="pl-3">
                                        <div class="text-base font-semibold">{{ date_conversion2(yearbooks.created_at) }}</div>
                                    </div>  
                                </td>
                                <td class="py-4 px-6">
                                    <div class="pl-3">
                                        <div class="text-base font-semibold">{{ date_conversion2(yearbooks.updated_at) }}</div>
                                    </div>  
                                </td>
