...
const function_update_post = () => {
    update_announcement_data.put(route('announcements.update',[update_announcement_data.id]), {
            preserveScroll: true,
            onSuccess: () => {
                announcement_data.reset()
                onAlert('Update')
...
const function_delete_post = () => {
    delete_announcement_data.delete(route('announcements.delete',[delete_announcement_data.id]), {
            preserveScroll: true,
            onSuccess: () => {
    ...
    <section class="text-gray-600 body-font relative">
        <div v-if="alertOn" class="bg-green-100 alertanim text-center py-4 lg:px-4">
            <div class="p-2 bg-green-800 items-center text-green-100 leading-none lg:rounded-full flex lg:inline-flex" role="alert">
                ...
                <span class="font-semibold mr-2 text-left flex-auto">Announcement Successfully added</span>
        ...
        <div v-if="alertOnUpdate" class="bg-blue-100 alertanim text-center py-4 lg:px-4">
            <div class="p-2 bg-blue-800 items-center text-blue-100 leading-none lg:rounded-full flex lg:inline-flex" role="alert">
                ...
                <span class="font-semibold mr-2 text-left flex-auto">Announcement Successfully updated</span>
                <svg class="fill-current opacity-75 h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M12.95 10.707l.707-.707L8 4.343 6.586 5.757 10.828 10l-4.242 4.243L8 15.657l4.95-4.95z"/></svg>
            </div>
        </div>
        <div v-if="alertOnDelete" class="bg-red-100 alertanim text-center py-4 lg:px-4">
            <div class="p-2 bg-red-800 items-center text-red-100 leading-none lg:rounded-full flex lg:inline-flex" role="alert">
                ...
                <span class="font-semibold mr-2 text-left flex-auto">Announcement Successfully deleted</span>
                <svg class="fill-current opacity-75 h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M12.95 10.707l.707-.707L8 4.343 6.586 5.757 10.828 10l-4.242 4.243L8 15.657l4.95-4.95z"/></svg>
            </div>
        </div>  
        ...
        <div class="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
                    ...
                    <table class="w-full max-w-7xl  text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tbody v-for="(announcements, key) in usePage().props.value.announcements.data" :key="key">
                            <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                                ...
                                <td class="py-4  max-w-[70vmin] w-[26vmin] px-2">
                                    {{announcements.content}}
                                </td>
                                <td class="py-4 px-6">
                                    {{date_conversion(announcements.created_at)}}
                                </td>
                                <td class="py-4 px-6">
                                    {{date_conversion_from_now(announcements.updated_at)}}
                                </td>
                                <td class="py-4 px-6">
                                ...
                                <td class="py-4 px-6">
                                    <a href="#" @click="function_open_update_modal(announcements.id ,announcements.title, announcements.content)" class="font-medium text-blue-600 dark:text-blue-500 hover:underline ml-2">Edit</a>
                                    <a href="#" @click="function_open_delete_modal(announcements.id)" class="font-medium text-red-600 hover:underline ml-2">Delete</a>
                                </td>
                            </tr>
                        </tbody>
                    </table>
            ...
            <div class="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
                ...
                <div class="relative mb-4">
                    ...
                    <input v-model="announcement_data.title" type="text" id="name" name="name"
                ...
                <div class="relative mb-4">
                    ...
                    <textarea v-model="announcement_data.content" id="message" name="message"
                ...
                <button @click="post_announcement()"
                    ...
                    <div class="relative p-4 w-full animate mt-10 max-w-md h-full md:h-auto">
                        <div class="relative bg-white rounded-lg shadow">
                                    <div class="p-2 w-full">
                                        <div class="relative">
                                            <label for="title" class="leading-7 text-sm text-gray-600">Title of Announcement</label>
                                            <input v-model="update_announcement_data.title" type="text" id="title" name="title" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-green-500 focus:bg-white focus:ring-2 focus:ring-green-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" required>
                                        </div>
                                    </div>
                                    <div class="p-2 w-full">
                                        <div class="relative">
                                                ...
                                                <textarea v-model="update_announcement_data.content" id="content" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500" placeholder="Your content..." required></textarea>
                            ...
                            <div class="p-6 text-center">
                                ...
                                <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Are you sure you want to update this post?</h3>
                                <button @click="function_update_post()" data-modal-toggle="popup-modal" type="button" class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2">
                                    Yes, I'm sure
                                </button>
                    ...
                    <div class="relative p-4 animate w-full max-w-md h-full mt-[20vmin] transition ease-in-out md:h-auto">
                        <div class="relative bg-white rounded-lg shadow">
                            ...
                            <div class="p-6 text-center">
                                ...
                                <button @click="function_delete_post()" data-modal-toggle="popup-modal" type="button" class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2">
                                    Yes, I'm sure
                                </button>
