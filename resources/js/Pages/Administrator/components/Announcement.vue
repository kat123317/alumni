...
<template>
    ...
    <section class="text-gray-600 body-font relative">
        ...
        <div class="container px-5 py-24  p-10 shadow-lg rounded-lg bg-white mt-10 mx-auto flex sm:flex-nowrap flex-wrap">

            <div
                class="lg:w-2/3  md:w-1/2 bg-gray-50 rounded-lg overflow-hidden sm:mr-10 p-10  items-start justify-center relative">
                <nav class=" mb-2 flex justify-end" aria-label="Page navigation example">
                        ...
                        <div class="relative">
                            ...
                            <input v-model="announcement_search.announcement_search_key" type="search"
                                id="default-search"
                            ...
                            <button @click="searchAnnouncements()" type="submit"
                ...
                <div class="overflow-x-auto  rounded relative">
                    ...
                    <table class="w-full max-w-7xl  text-sm text-left text-gray-500 dark:text-gray-400">
                        <thead class="text-xs text-gray-700 uppercase bg-green-500 text-white">
                            <tr>
                        ...
                        <tbody v-for="(announcements, key) in usePage().props.value.announcements.data" :key="key">
                            <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                                ...
                                <td class="py-4 px-6">
                                    <a href="#"
                                        @click="function_open_update_modal(announcements.id ,announcements.title, announcements.content)"
                                        class="font-medium text-blue-600 dark:text-blue-500 hover:underline ml-2">Edit</a>
                                    <a href="#" @click="function_open_delete_modal(announcements.id)"
                    ...
                    <div class="relative bg-white rounded-lg shadow">
                        <div class="p-2 w-full">
                            <div class="relative">
                                ...
                                <input v-model="update_announcement_data.title" type="text" id="title" name="title"
                        ...
                        <div class="p-2 w-full">
                            <div class="relative">
                                ...
                                <label for="content"
                                    ...
                                    content</label>
                                <textarea v-model="update_announcement_data.content" id="content" rows="4"
                ...
                <div class="relative p-4 animate w-full max-w-md h-full mt-[20vmin] transition ease-in-out md:h-auto">
                    <div class="relative bg-white rounded-lg shadow">
                        ...
                        <div class="p-6 text-center">
                            ...
                            <button @click="function_open_delete_modal()" data-modal-toggle="popup-modal" type="button"
                                class="text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10">No,
                                cancel</button>
                        </div>
                    </div>
