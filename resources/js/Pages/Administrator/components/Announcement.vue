...
const announcement_search = useForm({
    announcement_search_key: usePage().props.value.announcement_search_key
        ? usePage().props.value.announcement_search_key
        : "",
});
            ...
            >
                ...
                >
                    ...
                    <div class="relative">
                        ...
                        <input
                            v-model="
                                announcement_search.announcement_search_key
                            "
                            type="search"
                            id="default-search"
                    ...
                    >
                        ...
                        >
                            <tr>
                                ...
                                <th scope="col" class="py-3 px-6">Posted by</th>
                                <th scope="col" class="py-3 px-6">
                                    Updated by
                                </th>
                        ...
                        <tbody
                            v-for="(announcements, key) in usePage().props.value
                                .announcements.data"
                            :key="key"
                        >
                            <tr
                    ...
                    <div class="relative bg-white rounded-lg shadow">
                        ...
                        <div class="p-2 w-full">
                            <div class="relative">
                                ...
                                >
                                <textarea
                                    v-model="update_announcement_data.content"
                                    id="content"
                                    rows="4"
