...
<template>
    <div class="m-6">
        <div class="mb-5 flex">
            ...
            <select id="countries" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block ml-2 w-75 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
            <option selected>Choose a College</option>
            <option value="US">Engineering</option>
            <option value="FR">Forestry</option>
            <option value="DE">Veterenary Medicine</option>
            </select>
        ...
        <div class="container grid grid-cols-4 gap-5 mx-auto">
            <div v-for="yb in 20" class="max-w-sm bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
                ...
                <div class="p-5">
                    <a href="#">
                        <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Cabug-os, Allan Mark G.</h5>
                    </a>
