    ...
    <div class="m-6">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-6 text-center">
            ...
            >
                ...
                <div class="flex mt-2">
                    <button
                        :disabled="graduate.details.achievements == null"
                        type="button"
                        @click="openSelectedAchievements(key)"
                        class="inline-flex w-full items-center justify-center px-5 py-2.5 text-sm font-medium text-center text-white bg-green-700 rounded-lg hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300"
                    >
                        Achievements
                        <span
                            v-if="graduate.details.achievements != null"
                ...
                <div v-if="key == globalkey" class="grid mt-5 grid-cols-4">
                    <kbd
                        ...
                        :key="achievement_key"
                        class="p-2 m-1 text-xs font-semibold text-center text-gray-800 bg-gray-100 border border-gray-200 rounded-lg"
                        ><svg
                            xmlns="http://www.w3.org/2000/svg"
                            fill="none"
                            viewBox="0 0 24 24"
                            stroke-width="1.5"
                            stroke="currentColor"
                            class="w-7 mx-auto text-yellow-600 h-7"
                        >
                            <path
                                stroke-linecap="round"
                                stroke-linejoin="round"
