...
function onSelectEmoji(emoji) {
    ...
    message_data.content != null ?  message_data.content =  message_data.content + emoji.i :   message_data.content = emoji.i;
}
</script>
<template>
    <div class="bg-grey-lighter px-4 py-4 flex items-center">
        <div class="hover:text-yellow-200 cursor-pointer" @click="emojioverlay = !emojioverlay">
        ...
        <div v-if="emojioverlay" class=" bg-red-200 slide-in-elliptic-top-fwd flex justify-start">
        ...
        <div>
            <button  class="hover:text-green-500" @click="function_send_message($page.props.conversation_id)">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    stroke="currentColor" class="w-6 h-6">
                    <path class="hover:text-green-500" stroke-linecap="round" stroke-linejoin="round"
