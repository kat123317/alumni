            ...
            <article
                ...
                <div class="relative">
                    ...
                    <span class="flex absolute right-3 top-2/4 -mt-3 items-center">
                        ...
                        <svg class="fill-blue-500 dark:fill-slate-50" style="width: 24px; height: 24px;"
                            viewBox="0 0 24 24">
                ...
                <div class="pt-6">
                    <div class="media flex pb-4">
                        ...
                        <div class="media-body">
                            <div>
                                <a class="inline-block text-base font-bold mr-2" href="#">Tina
                                    Mills</a>
                                <span class="text-slate-500 dark:text-slate-300">3 minutes
                                    ago</span>
                            </div>
