            ...
            <div class="bg-gray-200">
                ...
                >
                    ...
                    >
                        ...
                        <span class="mx-2">Hey!</span>
                    </a>
                </div>
            </div>
            <div class="container mx-auto  ">
                <div class="mx-2 block lg:hidden">
                    <h1 class="text-center my-4 text-gray-800 font-bold">Messenger</h1>
                    ...
                    <div id="dropdownUsers" class=" z-10 w-full mt-2 bg-white rounded shadow ">
                        ...
                        <a href="#"
                            ...
                            <svg class="mr-1 w-5 h-5" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                ...
                <div class="py-6 px-2 ">
                    <div class="flex border border-grey h-[150vmin] lg:h-[80vmin] rounded shadow-lg">
                        ...
                        <div class="w-1/3 hidden lg:block border flex flex-col">
                            ...
                            <!-- Contacts -->
                            <div class="bg-grey-lighter w-[100vmin]   flex-1 overflow-auto">
