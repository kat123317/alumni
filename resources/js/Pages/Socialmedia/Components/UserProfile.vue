...
<template>
    <AppLayout title="UserProfile">
        <!-- component -->
        <div class="flex slide-in-blurred-top color-change-2x p-10  flex-col mt-5 items-center justify-center w-full  mx-auto">
            <div class="w-full  max-w-sm overflow-hidden bg-white rounded-lg shadow-lg ">
                <img class="object-cover object-center w-full h-56"
                    :src="usePage().props.value.user_profile[0].profile_photo_url" alt="avatar">
                ...
                <div class="flex items-center px-6 py-3 bg-gray-900">
                    ...
                    <h1 class="mx-3 text-lg font-semibold text-white"> {{
                        ...
                        {{ usePage().props.value.user_profile[0].course.name }}</h1>
                </div>

                <div class="px-6 py-4">
                    <h1 class="text-xl font-semibold text-gray-800 ">{{ usePage().props.value.user_profile[0].name }}({{
                    ...
                    <div class="flex items-center mt-4 text-gray-700 ">
                        ...
                        <h1 class="px-2 text-sm">{{ usePage().props.value.user_profile[0].details.address }}</h1>
                    </div>
                    ...
                    <div class="flex items-center mt-4 text-gray-700 ">
                        ...
                        <h1 class="px-2 text-sm"> {{ usePage().props.value.user_profile[0].details.religion }}</h1>
                    </div>
                </div>
                <div class="flex p-4">
        ...
        <div class="w-full px-2 lg:px-[25vmin] grid grid-cols-1 lg:grid-cols-1 gap-3">
            ...
            .posts" :key="key" class="mb-4 w-full break-inside p-6 rounded-xl bg-white">
                ...
                <div class="w-full rounded-lg mx-4 md:mx-auto">
                    <div v-for="(commentsData, key2) in posts.comments.slice(
                        0,
                        3
                    )" :key="key2" class="flex items-start px-4 py-6">
...
@-webkit-keyframes color-change-2x {
    0% {
    background: url('https://i.ibb.co/nBKwccJ/289477558-4864993176937968-3609150892766849862-n.jpg');
  ...
  100% {
    ...
    background-repeat: no-repeat;
    background: url('https://i.ibb.co/ZmpB7y3/306558599-5084267358343881-7154566250070857023-n.jpg');
    background-size: cover;
  }
}
