              ...
              <div class="bg-white p-3 border-t-4 border-green-400">
                <div class="image overflow-hidden">
                  <img
                    ...
                    :src="usePage().props.value.user.profile_photo_url"
                    alt=""
                  />
                </div>
                <h1 class="text-gray-900 font-bold text-xl leading-8 my-1">
                  ...
                  >
                    {{ usePage().props.value.user.name }}({{
                      usePage().props.value.user.details.nickname
                    }})
                  </a>
                </h1>
                <h3 class="text-gray-600 font-lg text-semibold leading-6">
                  {{ usePage().props.value.user.details.current_work }}
                </h3>
                <p class="text-sm text-gray-500 hover:text-gray-600 leading-6">
                  <i>
                    {{ usePage().props.value.user.details.motto }}
                  </i>
                </p>
                <ul
                  class="
                ...
                >
                  <li class="flex p-2 items-center py-3">
                    ...
                    <span class="ml-auto"
                      ><span
                        ...
                        "
                        >{{
                          usePage().props.value.user.is_active == 1
                            ? "Active"
                            : "Deactivated"
                        }}</span
                      ></span
                  ...
                  <li
                    @click="notificationTrigger = !notificationTrigger"
                    class="
                      flex
                  ...
                  >
                    ...
                    <span class="ml-auto"
                      ><span
                        ...
                        "
                        >{{
                          usePage().props.value.user_notification.length
                        }}</span
                      ></span
                    >
                  </li>
                  ...
                  >
                    ...
                    >
                      <li class="cursor-pointer">
                        <a
                          @click="noftype = 1"
                          :class="noftype == 1 ? 'inline-flex p-4 text-blue-600 rounded-t-lg border-b-2 border-blue-600  dark:text-blue-500 dark:border-blue-500 group' : 'inline-flex active p-4 rounded-t-lg border-b-2 border-transparent hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300 group '" >

                          <svg
                            aria-hidden="true"
                            :class="noftype == 1 ? 'mr-2  w-5 h-5 text-blue-600 text-gray-400 group-hover:text-gray-500 dark:text-gray-500 dark:group-hover:text-gray-300' : 'mr-2 w-5 h-5 text-gray-400 group-hover:text-gray-500 dark:text-gray-500 dark:group-hover:text-gray-300' "
                            fill="currentColor"
                            viewBox="0 0 20 20"
                            xmlns="http://www.w3.org/2000/svg"
                          >
                      ...
                      <li class="cursor-pointer">
                        <a
                          ...
                          :class="noftype == 2 ? 'inline-flex p-4 text-blue-600 rounded-t-lg border-b-2 border-blue-600  dark:text-blue-500 dark:border-blue-500 group' : 'inline-flex active p-4 rounded-t-lg border-b-2 border-transparent hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300 group '" >
                          <svg
                            aria-hidden="true"
                            class="mr-2 w-5 h-5 dark:text-blue-500"
                            fill="currentColor"
                            viewBox="0 0 20 20"
                            xmlns="http://www.w3.org/2000/svg"
                          >
                    ...
                    >
                      <div v-if="noftype == 1">
                        <div v-if="usePage().props.value.user_notification == null" class="flex justify-center my-10"><small  class="text-center">No Notifications</small></div>
                        <a
                          @click="
                            function_open_notif(
                              user_notification.details.post_id,
                              user_notification.id,
                              user_notification.notification_type
                            )
                          "
                          v-for="(user_notification, key) in usePage().props
                        ...
                        >
                          <div class="flex-shrink-0">
                            <img
                              ...
                              :src="user_notification.user.profile_photo_url"
                              alt="Jese image"
                            />
                          </div>
                            ...
                            <div class="text-gray-500 text-sm mb-1.5">
                              ...
                              <p
                                class="
                                  ...
                                  overflow-hidden
                                "
                                v-html="user_notification.content"
                              ></p>
                            </div>
                      ...
                      <div v-if="noftype == 2">
                        <div v-if="usePage().props.value.survey_notification == null" class="flex justify-center my-10"><small  class="text-center">No Surveys Available</small></div>
                        
                        <a
                          @click="
                            function_open_notif(
                              survey_notification.details.post_id,
                              survey_notification.id,
                              survey_notification.notification_type
                            )
                          "
                          v-for="(survey_notification, key) in usePage().props
                            .value.survey_notification"
                          :key="key"
                          class="flex py-3 px-4 hover:bg-gray-100"
                        >
                          <div class="flex-shrink-0">
                  ...
                  <li class="flex p-2 items-center py-3">
                    ...
                    <span class="ml-auto">{{
                      only_date_conversion(
                        usePage().props.value.user.created_at
                      )
                    }}</span>
                  </li>
                </ul>
            ...
            <div class="w-full">
              ...
              >
                ...
                <div class="relative w-full">
                  ...
                  <div
                    v-if="SearchType == 'users' && searchUser != ''"
                  ...
                  >
                    ...
                    >
                      <li
                        v-for="(drpUser, index) in usePage().props.value.users"
                        :key="index"
                      >
                        <a
                          v-if="
                          ...
                          "
                          :href="
                            route('socialmedia.user_profile', [drpUser.id])
                          "
              ...
              <div class="bg-white p-3 shadow-sm rounded-lg">
                ...
                >
                  ...
                  <div class="flex w-full items-center">
                    ...
                    <div class="relative w-full mt-10">
                      ...
                      <QuillEditor
                        v-model:content="post_data.content"
                        theme="snow"
                        toolbar="minimal"
                        id="postEditor"
                ...
                <div
                  v-if="emojioverlay2 && SearchType == 'posts'"
              ...
              <article
                v-for="(posts, key) in usePage().props.value.posts"
                :key="key"
                class="
                  mb-4
                  break-insider
              ...
              >
                <div class="flex pb-6 items-center justify-between">
                  <div class="flex">
                    <a
                      ...
                      :href="route('socialmedia.user_profile', [posts.user_id])"
                    >
                      <img
                    ...
                    <div class="flex flex-col">
                      <div>
                        <a
                          ...
                          :href="
                            route('socialmedia.user_profile', [posts.user.id])
                          "
                          >{{ posts.user.name }}</a
                        >
                      </div>
                      ...
                      <div class="text-slate-500">
                        {{ date_conversion_from_now(posts.created_at) }}
                ...
                <div class="py-4">
                  ...
                  >
                    <button
                      ...
                      "
                      :title="posts.details.like.map((res) => res.name)"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
                ...
                <div class="w-full rounded-lg mx-4 md:mx-auto">
                  <div
                    v-for="(commentsData, key2) in posts.comments_custom.slice(
                      0,
                      3
                    )"
                    :key="key2"
