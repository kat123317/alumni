        ...
        user_notification.title
                        ...
                        <div class="w-full">
                            ...
                            .posts" :key="key"
                                ...
                                <div class="py-4">
                                    <div @click="function_like_post(key)" class="inline-flex items-center">
                                        <button type="button"
                                          
                                            :class="!posts.details.like.includes(usePage().props.value.user.name) ? 'text-blue-700 border border-blue-700 hover:bg-blue-700 hover:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm p-2.5 text-center inline-flex items-center mr-2' : 'text-white border border-blue-700 bg-blue-800 hover:bg-blue-700 hover:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm p-2.5 text-center inline-flex items-center mr-2'"
                                ...
                                <div 
                                    class="w-full rounded-lg mx-4 md:mx-auto">
                                    <div v-for="(
                                        commentsData, key2
