                        ...
                        <div class="w-full">
                            ...
                            <div class="flex items-center mb-5">
                                ...
                                <div class="relative w-full">
                                    ...
                                    <input v-model="search_data.search_text" type="text" id="voice-search"
                                    ...
                                    <div class="flex w-full items-center">
                                        ...
                                        <div class="relative w-full">
                                            <div
                                                ...
                                                <path stroke-linecap="round" class="text-gray-500" stroke-linejoin="round" d="M10.34 15.84c-.688-.06-1.386-.09-2.09-.09H7.5a4.5 4.5 0 110-9h.75c.704 0 1.402-.03 2.09-.09m0 9.18c.253.962.584 1.892.985 2.783.247.55.06 1.21-.463 1.511l-.657.38c-.551.318-1.26.117-1.527-.461a20.845 20.845 0 01-1.44-4.282m3.102.069a18.03 18.03 0 01-.59-4.59c0-1.586.205-3.124.59-4.59m0 9.18a23.848 23.848 0 018.835 2.535M10.34 6.66a23.847 23.847 0 008.835-2.535m0 0A23.74 23.74 0 0018.795 3m.38 1.125a23.91 23.91 0 011.014 5.395m-1.014 8.855c-.118.38-.245.754-.38 1.125m.38-1.125a23.91 23.91 0 001.014-5.395m0-3.46c.495.413.811 1.035.811 1.73 0 .695-.316 1.317-.811 1.73m0-3.46a24.347 24.347 0 010 3.46" />
                                                </svg>

                                            </div>
                                            <input  @click="
                                            emojioverlay = false" type="text" v-model="post_data.content"
                                                class="bg-gray-50  border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  "
                                                placeholder="Hey! What's up?" required>
                                            <button type="button" @click="
                                            emojioverlay = !emojioverlay"
                                                class="flex absolute inset-y-0 right-0 items-center pr-3">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                                    <path stroke-linecap="round" class="text-yellow-600"  stroke-linejoin="round" d="M15.182 15.182a4.5 4.5 0 01-6.364 0M21 12a9 9 0 11-18 0 9 9 0 0118 0zM9.75 9.75c0 .414-.168.75-.375.75S9 10.164 9 9.75 9.168 9 9.375 9s.375.336.375.75zm-.375 0h.008v.015h-.008V9.75zm5.625 0c0 .414-.168.75-.375.75s-.375-.336-.375-.75.168-.75.375-.75.375.336.375.75zm-.375 0h.008v.015h-.008V9.75z" />
                                                    </svg>
                                ...
                                <div v-if="posts.photo != null" class="py-4 mx-auto">
                                    <div v-if="posts.photo.length > 3" class="grid grid-cols-2">
                                        <a class="flex" href="#" v-for="(photos, key) in posts.photo" :key="key">
                                            <img class="w-auto m-1 max-h-[30vmin] object-contain" :src="
                                                './images/posts/' + photos
                                            " />
                                        </a>
                                    </div>
                                    <div v-if="posts.photo.length == 3">
                                        <div class="grid grid-cols-2">
                                            <a class="flex" href="#" v-for="(
                                                ...
                                                <img v-if="key2 != 2" class="w-auto max-h-[30vmin] object-contain" :src="
                                                    './images/posts/' +
                                                    photos
                                                " />
                                            </a>
                                    ...
                                    <div v-if="posts.photo.length == 2" class="grid grid-cols-2 grid-rows-1 ...">
                                        <a class="flex" href="#" v-for="(photos, key) in posts.photo" :key="key">
                                            <img class="w-auto object-contain max-w-[40vmin]" :src="
                                                './images/posts/' + photos
                                            " />
                                        </a>
                                    </div>
                                    <div v-if="posts.photo.length == 1" class="grid grid-cols-1 grid-rows-1 ...">
                                        <a class="flex" href="#" v-for="(photos, key) in posts.photo" :key="key">
                                            <img class="w-auto object-contain max-w-[50vmin]" :src="
                                                './images/posts/' + photos
                                            " />
                                        </a>
                                    </div>
