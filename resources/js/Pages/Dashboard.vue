        ...
        user_notification.title
                        ...
                        <div class="w-full">
                            ...
                            <div class="bg-white p-3 shadow-sm rounded-sm">
                                ...
                                <div v-if="emojioverlay" class="absolute flex justify-end  mx-auto">
                                    <div>

                                        <EmojiPicker :native="true" @select="onSelectEmoji" />
                                        <button type="button" @click="emojioverlay = !emojioverlay"
                                            class=" float-right w-full text-white mt-1 bg-red-500 border border-gray-300 focus:outline-none hover:bg-red-900 focus:ring-4 focus:ring-gray-200 font-medium rounded-lg text-sm px-5 py-2.5 ">Close
                                        </button>
                                    </div>
                                ...
                                <div class="w-full h-10 flex justify-between mt-4 px-3 md:px-10 lg:px-24 xl:px-5">
                                    <div class="flex">
                                        ...
                                        <button @click="emojioverlay = !emojioverlay" class="flex h-full items-center">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                                stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                                <path class="text-yellow-600" stroke-linecap="round"
                                                    stroke-linejoin="round"
                                                    d="M15.182 15.182a4.5 4.5 0 01-6.364 0M21 12a9 9 0 11-18 0 9 9 0 0118 0zM9.75 9.75c0 .414-.168.75-.375.75S9 10.164 9 9.75 9.168 9 9.375 9s.375.336.375.75zm-.375 0h.008v.015h-.008V9.75zm5.625 0c0 .414-.168.75-.375.75s-.375-.336-.375-.75.168-.75.375-.75.375.336.375.75zm-.375 0h.008v.015h-.008V9.75z" />
                                            </svg>

                                            <span class="text-xs lg:text-md mx-2 font-semibold text-gray-500">Add Emoji
                                            </span>
                                        </button>
                                    </div>
