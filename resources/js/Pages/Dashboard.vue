        ...
        user_notification.title
                        ...
                        <div class="w-full ">
                            ...
                            .posts" :key="key"
                                ...
                                <div v-if="posts.photo != null" class="py-4">
                                    <div v-if="posts.photo.length != 1" class="grid  grid-cols-2 grid-rows-1 ...">
...
">
                                            ...
                                            <span class="ml-1 font-bold">{{ posts.details.like.length }}</span>
                                        </button>
                                    </div>
                                </div>
