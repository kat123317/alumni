                ...
                <div class="container mx-auto my-5 p-5">
                    <div class="md:flex md:-mx-2">
                        ...
                        <div class="w-full">
                            ...
                            <div
                                v-if="emojioverlay"
                                class="z-20 slide-in-elliptic-top-fwd bg-red-200 flex justify-end"
                            >
                            ...
                            <div class="bg-white p-3 shadow-sm rounded-lg">
                                ...
                                <div
                                    v-if="
                                        emojioverlay2 && SearchType == 'posts'
                                    "
                                ...
                                <div
                                    class="w-full h-10 flex justify-between mt-12 px-3 md:px-10 lg:px-24 xl:px-5"
                                >
                                    <div class="flex">
                                        <button
                                            @click="openFile()"
