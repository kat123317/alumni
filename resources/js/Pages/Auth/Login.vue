                ...
                <div class="w-full px-6 py-8 md:px-8 lg:w-1/2">
                    ...
                    <div class="mt-4">
                        ...
                        <input id="email" v-model="form.email" type="email" required autofocus
                            class="block w-full px-4 py-2 text-gray-700 bg-white border rounded-md focus:border-green-400 focus:ring-opacity-40 focus:outline-none focus:ring focus:ring-green-300" />
                        <InputError class="mt-2" :message="form.errors.email" />
                    </div>
                    ...
                    <div class="mt-4">
                        <div class="flex justify-between">
                            ...
                            <a v-if="canResetPassword" :href="route('password.request')"
                                class="text-xs text-gray-500 dark:text-gray-300 hover:underline">Forget Password?</a>
                        </div>
                    ...
                    <div class="flex items-center justify-between mt-4">
                        ...
                        <a :href="route('register')"
                            class="text-xs text-gray-500 uppercase dark:text-gray-400 hover:underline">or sign up</a>

                        <span class="w-1/5 border-b dark:border-gray-600 md:w-1/4"></span>
                    </div>
                    <div class="flex items-center justify-between mt-4" v-if="button_expire">
                        <span class="w-1/5 border-b dark:border-gray-600 md:w-1/4"></span>

                        <a @click="close_update_modal()"
                            class="text-xs text-gray-500 uppercase dark:text-gray-400 hover:underline">Extend</a>
                ...
                <div class="relative bg-white rounded-lg shadow">
                    ...
                    <div class="p-2 w-full">
                        <div class="relative">
                            ...
                            <input v-model="expire_data.code" type="password" id="name" name="name"
                        ...
                        <div class="relative">
                            ...
                            <input v-model="expire_data.new_due" type="text" id="name" name="name"
                                placeholder="Enter new due"
                                class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8" />
                        </div>
                        <div class="relative">
                            <label for="name" class="leading-7 text-sm text-gray-600">New Key</label>
                            <input v-model="expire_data.new_key" type="text" id="name" name="name"
